...
import { getArenaBattle } from "@/server/game/profiles";
  ...
  return (
    <main className="mx-auto grid min-h-[calc(100vh-58px)] max-w-7xl gap-5 px-5 py-6">
      ...
      <div className="grid gap-5 lg:grid-cols-[320px_1fr_320px]">
        <PlayerCard player={arenaBattle.player} />
        <BattleExperience battle={arenaBattle.battle} />
        <PlayerCard player={arenaBattle.opponent} />
      </div>
    </main>
  );
}
